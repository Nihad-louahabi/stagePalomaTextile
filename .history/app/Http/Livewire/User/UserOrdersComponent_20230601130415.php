...
class UserOrdersComponent extends Component
{
    public function render()
    {
        ...
        return view('livewire.user.user-orders-component',['orders'=>$orders,'totalCost'=>$totalCost,'totalPurchase'=>$totalPurchase,'totalDelivered'=>$totalDelivered,'totalCanceled']);
    }
}

            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="about.html{{ route('about') }}">@lang('public.About')</a></li>
                                    ...
                                    @auth
                                        <li><a href="#">@lang('public.My Account')<i class="fi-rs-angle-down"></i></a>
                                            @if (Auth::user()->utype == 'ADM')
                                                <ul class="sub-menu">
                                                    <li><a href="{{route('admin.dashboard')}}">@lang('public.Dashboard')</a></li>
                                                    ...
                                                    <li><a href="#">@lang('public.Customer ')</a></li>
                                                </ul>
                                            @else
                                                <ul class="sub-menu">
                                                    <li><a href="{{route('user.dashboard')}}">@lang('public.Dashboard')</a></li>
                                                    <li><a href="{{route('user.orders')}}">@lang('public.My Orders')</a></li>
                                                </ul>
                                            @endif
                                        </li>
                                    @endif
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>@lang('public.Toll Free')</span> (+212) </p>
                    </div>
                    ...
                    <div class="col-lg-7 mb-md-3 mb-lg-0">
                        <div class="row align-items-center">
                            <div class="col flex-horizontal-center">
                                ...
                                <h4 class="font-size-20 mb-0 ml-3">@lang('public.Sign up to Newsletter')</h4>
                            </div>
                            <div class="col my-4 my-md-0 des">
                                <h5 class="font-size-15 ml-4 mb-0">@lang('public....and receive') <strong>$25 @lang('public.coupon for first shopping.')</strong></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        ...
                        <form class="form-subcriber d-flex wow fadeIn animated">
                            ...
                            <button class="btn bg-dark text-white" type="submit">@lang('public.Subscribe')</button>
                        </form>
                        <!-- End Subscribe Form -->
                    </div>
                </div>
